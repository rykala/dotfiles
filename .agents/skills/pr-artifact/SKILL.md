...
through a pull request. Not a diff dump — a narrative. It explains _what_ changed, _why_ each
decision was made, and _what problems came up and how they were solved_, ordered so the reader
...
2. **Gather everything.** Pull the full picture, not just the diff:
   ...
   - Linked issues (from the body / commit trailers) — read them for the _original_ problem.
